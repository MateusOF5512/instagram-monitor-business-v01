...
def get_data( path_globo ):
    df = pd.read_csv( path_globo )
    return df
...
seg_MN=df_map["inter"].iloc[0]; seg_TD=df_map["inter"].iloc[2]; seg_NT=df_map["inter"].iloc[1]; seg_MD=0;
ter_MN=df_map["inter"].iloc[4]; ter_TD=df_map["inter"].iloc[6]; ter_NT=df_map["inter"].iloc[5]; ter_MD=df_map["inter"].iloc[3];
qua_MN=df_map["inter"].iloc[8]; qua_TD=df_map["inter"].iloc[10]; qua_NT=df_map["inter"].iloc[9]; qua_MD=df_map["inter"].iloc[7];
qui_MN=df_map["inter"].iloc[12]; qui_TD=df_map["inter"].iloc[13]; qui_NT=0                     ; qui_MD=df_map["inter"].iloc[11];
sex_MN=df_map["inter"].iloc[15]; sex_TD=df_map["inter"].iloc[17]; sex_NT=df_map["inter"].iloc[16]; sex_MD=df_map["inter"].iloc[14];
sab_MN=df_map["inter"].iloc[19]; sab_TD=df_map["inter"].iloc[21]; sab_NT=df_map["inter"].iloc[20]; sab_MD=df_map["inter"].iloc[18];
dom_MN=df_map["inter"].iloc[23]; dom_TD=df_map["inter"].iloc[25]; dom_NT=df_map["inter"].iloc[24]; dom_MD=df_map["inter"].iloc[22];
...
seg_MN=df_map["conta"].iloc[0]; seg_TD=df_map["conta"].iloc[2]; seg_NT=df_map["conta"].iloc[1]; seg_MD=0;
ter_MN=df_map["conta"].iloc[4]; ter_TD=df_map["conta"].iloc[6]; ter_NT=df_map["conta"].iloc[5]; ter_MD=df_map["conta"].iloc[3];
qua_MN=df_map["conta"].iloc[8]; qua_TD=df_map["conta"].iloc[10]; qua_NT=df_map["conta"].iloc[9]; qua_MD=df_map["conta"].iloc[7];
qui_MN=df_map["conta"].iloc[12]; qui_TD=df_map["conta"].iloc[13]; qui_NT=0                     ; qui_MD=df_map["conta"].iloc[11];
sex_MN=df_map["conta"].iloc[15]; sex_TD=df_map["conta"].iloc[17]; sex_NT=df_map["conta"].iloc[16]; sex_MD=df_map["conta"].iloc[14];
sab_MN=df_map["conta"].iloc[19]; sab_TD=df_map["conta"].iloc[21]; sab_NT=df_map["conta"].iloc[20]; sab_MD=df_map["conta"].iloc[18];
dom_MN=df_map["conta"].iloc[23]; dom_TD=df_map["conta"].iloc[25]; dom_NT=df_map["conta"].iloc[24]; dom_MD=df_map["conta"].iloc[22];
