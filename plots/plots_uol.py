...
def get_data( path_uol ):
    df = pd.read_csv( path_uol )
    return df
...
ter_MN=df_map["inter"].iloc[3]; ter_TD=df_map["inter"].iloc[5]; ter_NT=df_map["inter"].iloc[4]; ter_MD=0;
qua_MN=df_map["inter"].iloc[6]; qua_TD=df_map["inter"].iloc[8]; qua_NT=df_map["inter"].iloc[7]; qua_MD=0;
qui_MN=df_map["inter"].iloc[9]; qui_TD=df_map["inter"].iloc[11]; qui_NT=df_map["inter"].iloc[10]; qui_MD=0;
sex_MN=df_map["inter"].iloc[13]; sex_TD=df_map["inter"].iloc[15]; sex_NT=df_map["inter"].iloc[14]; sex_MD=df_map["inter"].iloc[12];
sab_MN=df_map["inter"].iloc[16]; sab_TD=df_map["inter"].iloc[17]; sab_NT=0; sab_MD=0;
dom_MN=df_map["inter"].iloc[18]; dom_TD=df_map["inter"].iloc[19]; dom_NT=0; dom_MD=0;
...
ter_MN=df_map["conta"].iloc[3]; ter_TD=df_map["conta"].iloc[5]; ter_NT=df_map["conta"].iloc[4]; ter_MD=0;
qua_MN=df_map["conta"].iloc[6]; qua_TD=df_map["conta"].iloc[8]; qua_NT=df_map["conta"].iloc[7]; qua_MD=0;
qui_MN=df_map["conta"].iloc[9]; qui_TD=df_map["conta"].iloc[11]; qui_NT=df_map["conta"].iloc[10]; qui_MD=0;
sex_MN=df_map["conta"].iloc[13]; sex_TD=df_map["conta"].iloc[15]; sex_NT=df_map["conta"].iloc[14]; sex_MD=df_map["conta"].iloc[12];
sab_MN=df_map["conta"].iloc[16]; sab_TD=df_map["conta"].iloc[17]; sab_NT=0; sab_MD=0;
dom_MN=df_map["conta"].iloc[18]; dom_TD=df_map["conta"].iloc[19]; dom_NT=0; dom_MD=0;
