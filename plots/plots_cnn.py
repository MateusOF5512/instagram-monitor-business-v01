...
def get_data( path_cnn ):
    df = pd.read_csv( path_cnn )
    return df
...
qua_MN=df_map["inter"].iloc[8]; qua_TD=df_map["inter"].iloc[10]; qua_NT=df_map["inter"].iloc[9]; qua_MD=0;
...
sab_MN=df_map["inter"].iloc[17]; sab_TD=df_map["inter"].iloc[19]; sab_NT=df_map["inter"].iloc[18]; sab_MD=0;
dom_MN=df_map["inter"].iloc[20]; dom_TD=df_map["inter"].iloc[22]; dom_NT=df_map["inter"].iloc[21]; dom_MD=0;
...
qua_MN=df_map["conta"].iloc[8]; qua_TD=df_map["conta"].iloc[10]; qua_NT=df_map["conta"].iloc[9]; qua_MD=0;
...
sab_MN=df_map["conta"].iloc[17]; sab_TD=df_map["conta"].iloc[19]; sab_NT=df_map["conta"].iloc[18]; sab_MD=0;
dom_MN=df_map["conta"].iloc[20]; dom_TD=df_map["conta"].iloc[22]; dom_NT=df_map["conta"].iloc[21]; dom_MD=0;
